  ...
  return (
    <div className="flex items-center justify-between py-2">
      ...
      <button
        ...
        className={`relative w-10 h-5 rounded-full transition-colors ${value ? 'bg-cyan-500' : 'bg-slate-600'}`}
      >
        <span
  ...
  return (
    <Modal isOpen={activeDialog === 'settings'} onClose={closeDialog} title="设置" width="max-w-md">
      <div className="space-y-5">
        <div>
          <h3 className="text-xs font-semibold text-slate-400 uppercase tracking-wider mb-2">视图</h3>
          <div className="bg-slate-700/30 rounded-lg px-4 py-1">
        ...
        <div>
          <h3 className="text-xs font-semibold text-slate-400 uppercase tracking-wider mb-2">脱模角度</h3>
        ...
        <div>
          <h3 className="text-xs font-semibold text-slate-400 uppercase tracking-wider mb-2">壁厚分析</h3>
          <div className="bg-slate-700/30 rounded-lg px-4 py-2">
        ...
        <div>
          <h3 className="text-xs font-semibold text-slate-400 uppercase tracking-wider mb-2">滤水孔</h3>
          <div className="bg-slate-700/30 rounded-lg px-4 py-2">
